		...
		<header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
			<div className="container flex h-14 sm:h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<span className="font-serif font-bold text-lg sm:text-xl text-foreground">
						DapurKita
					</span>
				</Link>
				...
				<Sheet open={isOpen} onOpenChange={setIsOpen}>
					<SheetTrigger asChild className="md:hidden">
						<Button
							variant="ghost"
							size="sm"
							className="h-8 w-8 p-0 hover:bg-amber-50 transition-colors"
						>
								...
								{isLoggedIn ? (
									<>
										...
										<Button
											...
											className="justify-start bg-transparent h-12 hover:bg-gray-50 hover:text-gray-700 transition-colors"
										>
