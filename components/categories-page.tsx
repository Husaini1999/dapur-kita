			...
			<div className="container mx-auto px-4 py-8 sm:py-12">
				...
				<section className="mb-12 sm:mb-16">
					<div className="flex items-center justify-between mb-6 sm:mb-8">
						...
						<Badge
							variant="secondary"
							className="bg-saffron-yellow/10 text-saffron-yellow border-saffron-yellow/20"
						>
							Most Ordered
						</Badge>
					</div>
							...
							<Link key={category.id} href={`/browse?category=${category.id}`}>
								...
								>
									<div className="relative h-48 sm:h-52">
										...
										/>
										{category.popular && (
											<Badge className="absolute top-3 left-3 bg-saffron-yellow text-white">
												Popular
											</Badge>
										)}
									</div>
				...
				<div className="text-center mt-12 sm:mt-16 p-6 sm:p-8 bg-gradient-to-r from-saffron-yellow/10 to-amber-100 rounded-2xl">
					...
					<p className="text-gray-600 mb-6 max-w-2xl mx-auto">
						Browse all our amazing home cooks or use our advanced search to find
