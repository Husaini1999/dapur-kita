...
const mockReviews = [
  ...
  },
  {
    ...
    rating: 4,
    date: "1 week ago",
    comment: "Great rendang, very authentic taste. Delivery was on time and food was still warm. Highly recommended!",
...
export function ReviewsSection({ cookId }: ReviewsSectionProps) {
  return (
        ...
        <CardContent className="p-6">
          <div className="flex items-center space-x-6">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground mt-1">127 reviews</div>
            </div>
