...
import { CheckCircle, Clock, MapPin, Phone, MessageCircle, Home, Star } from "lucide-react"
    ...
    <div className="container max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="text-center space-y-6 mb-12">
        ...
        <div className="space-y-2">
          <h1 className="font-serif font-bold text-3xl text-foreground">Order Confirmed!</h1>
          <p className="text-lg text-muted-foreground">
            Thank you for your order. We've received it and the cook is preparing your delicious meal.
          </p>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">{order.estimatedDelivery}</div>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm">Order confirmed - {order.orderTime}</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div key={index} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    {cookOrder.dishes.map((dish, dishIndex) => (
                      <div key={dishIndex} className="flex justify-between text-sm">
                        <span>
                          {dish.quantity}x {dish.name}
                        </span>
                        <span>RM {(dish.quantity * dish.price).toFixed(2)}</span>
                      </div>
                    ))}
                  </div>
        ...
        <div className="space-y-6">
          ...
          {/* Actions */}
          <div className="space-y-3">
            <Button asChild className="w-full bg-saffron-yellow hover:bg-saffron-yellow/90 text-spice-brown">
