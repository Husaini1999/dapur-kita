...
import { Star, MapPin, Clock, Truck, ShoppingBag, Phone, MessageCircle, Shield, Award } from "lucide-react"
  ...
  menu: [
    {
      ...
      description: "Fragrant coconut rice with sambal, fried anchovies, peanuts, boiled egg, and cucumber",
      cookingTime: "30 mins",
      available: true,
      rating: 4.9,
      reviewCount: 45,
    ...
    },
    {
      ...
      description: "Nyonya-style chicken braised in fermented bean sauce with potatoes",
      cookingTime: "40 mins",
      available: true,
      rating: 4.7,
      reviewCount: 28,
    ...
    },
    {
      ...
      description: "Traditional layered steamed cake with pandan and coconut flavors",
      cookingTime: "20 mins",
      available: false,
      rating: 4.6,
      reviewCount: 22,
...
const categories = ["All", "Rice Dishes", "Main Dishes", "Desserts", "Beverages"]
...
export function CookProfile({ cookId }: CookProfileProps) {
  ...
  const filteredMenu =
    selectedCategory === "All" ? cook.menu : cook.menu.filter((dish) => dish.category === selectedCategory)
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="relative">
            <Avatar className="w-24 h-24 border-4 border-background shadow-lg">
              <AvatarImage src={cook.image || "/placeholder.svg"} alt={cook.ownerName} />
          ...
          <div className="flex-1 space-y-4">
            <div className="space-y-2">
              <h1 className="font-serif font-bold text-3xl text-foreground">{cook.name}</h1>
              <p className="text-lg text-muted-foreground">by {cook.ownerName}</p>
            ...
            <div className="flex flex-wrap gap-2">
              {cook.achievements.map((achievement) => (
                <Badge key={achievement} variant="secondary" className="bg-accent/10 text-accent border-accent/20">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex space-x-2">
              <Button variant="outline" size="sm" className="bg-transparent hover:bg-amber-50 hover:text-amber-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">{cook.deliveryTime}</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">RM {cook.deliveryFee.toFixed(2)}</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">RM {cook.minOrder.toFixed(2)}</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">100% Verified</div>
              </div>
            </div>
          </div>
        </CardContent>
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t">
                <div className="text-center">
                  <div className="font-semibold text-2xl text-primary">{cook.totalOrders}+</div>
                  <div className="text-sm text-muted-foreground">Total Orders</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold text-2xl text-primary">{cook.rating}</div>
                  <div className="text-sm text-muted-foreground">Average Rating</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold text-2xl text-primary">{cook.joinedDate}</div>
                  <div className="text-sm text-muted-foreground">Joined DapurKita</div>
                </div>
              </div>
            </CardContent>
          </Card>
