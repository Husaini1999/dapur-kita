    ...
    <section className="relative py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-secondary/30 to-primary/5">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
            <div className="space-y-4 lg:space-y-6">
              <Badge variant="secondary" className="border-accent/20 w-fit mx-auto lg:mx-0 text-black bg-green-400">
                100% Halal Certified
              </Badge>
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-lg mx-auto lg:mx-0">
                Connect with talented home-based cooks in your neighborhood. Experience the warmth of Malaysian
                hospitality through authentic, homemade dishes crafted with love.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto lg:mx-0">
              <div className="relative flex-1">
                ...
                <Input placeholder="Search for dishes or cooks..." className="pl-10 h-11 sm:h-12" />
              </div>
              <Button size="lg" className="bg-primary hover:bg-primary/90 h-11 sm:h-12 px-6 sm:px-8">
                Find Food
              </Button>
            </div>
            ...
            <div className="flex items-center justify-center lg:justify-start space-x-6 sm:space-x-8 pt-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="font-semibold text-sm sm:text-base text-foreground">500+</div>
                  <div className="text-xs text-muted-foreground">Home Cooks</div>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <Utensils className="h-4 w-4 sm:h-5 sm:w-5 text-primary" />
                <div>
                  <div className="font-semibold text-sm sm:text-base text-foreground">2,000+</div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="font-semibold text-sm sm:text-base text-foreground">4.8</div>
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-card border rounded-lg p-2 sm:p-3 shadow-lg">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="font-semibold text-xs sm:text-sm">Highly Rated</div>
            ...
            <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 bg-card border rounded-lg p-2 sm:p-3 shadow-lg">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="font-semibold text-xs sm:text-sm">Fresh Daily</div>
                  <div className="text-xs text-muted-foreground">Made to order</div>
                </div>
              </div>
            </div>
            <div className="absolute top-1/4 -left-4 sm:-left-6 bg-card border rounded-lg p-1 shadow-lg">
              <img src="/nasi-lemak.png" alt="Nasi Lemak" className="w-12 h-12 sm:w-16 sm:h-16 object-cover rounded" />
            </div>
            <div className="absolute bottom-1/4 -right-4 sm:-right-6 bg-card border rounded-lg p-1 shadow-lg">
              <img
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-card border rounded-lg p-1 shadow-lg opacity-90">
              <img
      ...
      <div className="container max-w-6xl mx-auto mt-12 sm:mt-16">
        <div className="text-center mb-8">
          <h2 className="font-serif font-bold text-2xl sm:text-3xl text-foreground mb-2">Popular Malaysian Dishes</h2>
          <p className="text-muted-foreground">Authentic flavors crafted by our talented home cooks</p>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="group cursor-pointer">
            ...
            <p className="text-center mt-2 font-medium text-sm">Banana Leaf Rice</p>
          </div>
          <div className="group cursor-pointer">
            <div className="aspect-square rounded-xl overflow-hidden bg-card border">
              <img
