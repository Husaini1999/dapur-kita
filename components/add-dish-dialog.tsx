		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
				<DialogHeader>
					...
					<DialogDescription>
						Create a new dish for your menu. Make sure to include appetizing
						...
						<div className="grid grid-cols-3 gap-4">
							...
							<div className="space-y-2">
								...
								<Select
									...
									onValueChange={(value) =>
										setFormData({ ...formData, servingSize: value })
									}
								>
									<SelectTrigger>
						...
						<div className="flex items-start space-x-6">
							...
							<div className="space-y-2">
								...
								<p className="text-xs text-muted-foreground">
									Upload a high-quality photo of your dish. Good photos increase
									orders by 40%!
								</p>
							</div>
						</div>
